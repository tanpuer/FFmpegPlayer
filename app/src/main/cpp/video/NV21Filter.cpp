...
NV21Filter::NV21Filter(std::shared_ptr<AssetManager> &assetManager)
        : IFilter(assetManager, "nv21_fragment_shader.glsl") {

}

void NV21Filter::drawTextures(VideoData *data) {
